...
| J2-L2 | Low | **35 `page 2.tsx` / `page 3.tsx` duplicate files** in `~/Desktop/booking/app/`. Confirmed not routable by Next.js App Router and not imported anywhere. Dead code, safe to delete. |
