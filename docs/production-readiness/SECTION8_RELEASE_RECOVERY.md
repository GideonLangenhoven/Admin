...
The bounded staff smoke reached 500 VUs and was aborted on decisive latency and failure-rate breaches. Integrity stayed clean, one scheduler request timed out during the load window, the next minute recovered, and the post-stop browser smoke passed 4/4. Cross-origin dial-stage timeouts mean generator/egress saturation is not yet separated from target capacity. Repeat progressively from an instrumented independent generator and retain the original thresholds.
