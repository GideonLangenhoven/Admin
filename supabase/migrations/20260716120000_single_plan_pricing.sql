...
INSERT INTO public.plans (id, name, monthly_price_zar, seat_limit, extra_seat_price_zar, active)
VALUES ('standard', 'Standard', 2000, 1, 500, true)
ON CONFLICT (id) DO UPDATE
  SET name = 'Standard', monthly_price_zar = 2000, seat_limit = 1,
      extra_seat_price_zar = 500, active = true, updated_at = now();
