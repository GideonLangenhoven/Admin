...
export var starterTemplates: StarterTemplate[] = [
  ...
  /* 2 — Welcome Email */
  {
    ...
    blocks: () => [
      ...
      { type: "button", id: uid(), text: "View Our Tours", url: "https://capekayak.co.za/tours", color: "#0f5dd7" },
      defaultSocial(),
      defaultFooter(),
    ],
  },
  ...
  /* 3 — Newsletter */
  {
    ...
    blocks: () => [
      ...
      { type: "button", id: uid(), text: "Read More on Our Blog", url: "https://capekayak.co.za/blog", color: "#0f5dd7" },
      defaultFooter(),
    ],
  },
  ...
  /* 4 — Promotional Sale */
  {
    ...
    blocks: () => [
      ...
      { type: "button", id: uid(), text: "Claim Your Discount", url: "https://capekayak.co.za/book?promo=SUMMER25", color: "#dc2626" },
      defaultFooter(),
    ],
  },
  ...
  /* 5 — Event Announcement */
  {
    ...
    blocks: () => [
      ...
      { type: "button", id: uid(), text: "Reserve Your Spot", url: "https://capekayak.co.za/events/full-moon-paddle", color: "#1e40af" },
      defaultSocial(),
      defaultFooter(),
    ],
  },
  ...
  /* 7 — Birthday */
  {
    ...
    blocks: () => [
      ...
      { type: "button", id: uid(), text: "Redeem Your Birthday Gift", url: "https://capekayak.co.za/book?promo=BDAY15", color: "#9333ea" },
      defaultFooter(),
    ],
  },
  ...
  /* 8 — Re-engagement */
  {
    ...
    blocks: () => [
      ...
      { type: "button", id: uid(), text: "Book Your Next Adventure", url: "https://capekayak.co.za/book?promo=COMEBACK10", color: "#0891b2" },
  ...
  /* 9 — Feedback Request */
  {
    ...
    blocks: () => [
      ...
      { type: "button", id: uid(), text: "Share Your Feedback", url: "https://capekayak.co.za/feedback", color: "#059669" },
  ...
  /* 10 — Holiday Special */
  {
    ...
    blocks: () => [
      ...
      { type: "tourcard", id: uid(), imageUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=600", title: "Sunset Paddle", price: "R 450", ctaText: "Book Now", ctaUrl: "https://capekayak.co.za/tours/sunset-paddle" },
      { type: "button", id: uid(), text: "View All Holiday Deals", url: "https://capekayak.co.za/holiday-specials", color: "#b91c1c" },
      defaultFooter(),
    ],
  },
  ...
  /* 11 — Tour Showcase */
  {
    ...
    blocks: () => [
      ...
      { type: "tourcard", id: uid(), imageUrl: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600", title: "Whale Watching Kayak Tour", price: "R 650", ctaText: "Book Now", ctaUrl: "https://capekayak.co.za/tours/whale-watching" },
      { type: "button", id: uid(), text: "View All Tours", url: "https://capekayak.co.za/tours", color: "#0f5dd7" },
      defaultSocial(),
      defaultFooter(),
    ],
  },
