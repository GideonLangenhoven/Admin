  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="anim-fade-up flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        {refunds.length > 1 && (
          <button disabled={!!processing} onClick={refundAll} className="ui-btn ui-btn-danger w-full sm:w-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <div className="grid grid-cols-1 gap-2 sm:flex sm:flex-col">
                      ...
                      {b.refund_status === "MANUAL_EFT_REQUIRED" && <button onClick={() => manualRefund(b.id)} disabled={isProcessing}
                        className="ui-btn ui-btn-ghost whitespace-nowrap">
                        Confirm bank transfer
                      </button>}
                      <button onClick={() => declineRefund(b.id)} disabled={isProcessing || !["REQUESTED", "FAILED"].includes(b.refund_status)}
