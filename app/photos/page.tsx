    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="anim-fade-up anim-d1 grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-4">
            ...
            <div className="ui-card p-4">
              ...
              {uploadFiles.length > 0 && (
                <div className="mt-3 space-y-2">
                  ...
                  <button data-demo-action="photo.upload" onClick={uploadToDrive} disabled={uploading || !selectedSlot}
              ...
              <>
                ...
                <div className="mb-4 rounded-xl border border-dashed p-3" style={{ borderColor: "var(--ck-border-strong)", background: "var(--ck-surface-sunken)" }}>
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <button data-demo-action="photo.links" type="button" onClick={importBulkUrls} className="ui-btn ui-btn-ghost !h-8 !px-3 !text-xs">
                      Import links
                    </button>
                  </div>
                  <textarea
          ...
          <button data-demo-action="photo.send" onClick={sendPhotos} disabled={sending || !selectedSlot || urls.every(u => !u.trim())}
